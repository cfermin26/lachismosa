              ...
              <Row className="d-flex justify-content-center">
                <Col md={4} className="my-auto">
                  <p className="texto-lachismosa">
                    <ul className="lista-carrera">
                      ...
                      <li>
                        <span className="carrera-bold">Km1:</span> Av. Solano y
                        Daniel Cordova, sector
                        <br className="d-none d-sm-block" /> colegio Benigno
                        Malo.
                      </li>
                      <li>
                        <span className="carrera-bold">Km2:</span>: Av. Solano y
                        10 de agosto, sector
                ...
                <Col md={4} className="my-auto">
                  <p className="texto-lachismosa">
                    <ul className="lista-carrera">
                      <li>
                        <span className="carrera-bold">Km3:</span> 24 de mayo y
                        la Y subida a turi.
                      </li>
                      <li>
        ...
        <Row className="mt-3 mt-md-4">
          <Col md={12} className="mt-4 mt-md-5 text-center">
            ...
            <p className="texto-lachismosa mb-1 lh-1 mt-4 mt-md-5">
              - La seguridad será brindada por la Policía Nacional a lo largo de
              todo el recorrido.
            </p>
            ...
            <p className="texto-lachismosa mb-1 lh-1">
              - Para la prevención y socorro se contará con el apoyo de la Cruz
              Roja y Cuerpo de Bomberos de Cuenca.
            </p>
            <p className="texto-lachismosa mb-1 lh-1">
            ...
            <p className="texto-lachismosa mb-0 mt-4 mt-md-5">
              <ol className="lista-carrera">
                <li>
                  ...
                  <br className="d-none d-sm-block" /> que permita al competidor
                  correr en condiciones seguras.
                </li>
                <li>
                  Es obligatorio para los participantes inscritos correr con la
                  camiseta oficial.
                </li>
                <li>
                  Los organizadores del evento y auspiciantes de la competencia
                  no se responsabilizan por <br className="d-none d-sm-block" />
            ...
            <Container>
              ...
              <Row className="d-flex justify-content-center mt-2">
                <Col md={5} className="br-light">
                  <p className="texto-lachismosa">
                    <ol className="lista-carrera">
                      <li>
                        Para participar oficialmente en la carrera es necesario
                        inscribirse.
                      </li>
                      <li>
                ...
                <Col md={5}>
                  <p className="texto-lachismosa">
                    <ol start="3" className="lista-carrera">
                      ...
                      <li>
                        El competidor inscrito que no retire su kit o que no se
                        presente el día del evento no recibirá el kit de
                        competidor.
                      </li>
                    </ol>
                  </p>
              ...
              <Row>
                <Col md={12} className="mt-4">
                  <h4 className="titulo-reglas text-center">KITS COMPETIDOR</h4>
                </Col>
              </Row>
              <Row className="d-flex justify-content-center mt-2">
                  ...
                  <p className="texto-lachismosa">
                    <ol className="lista-carrera">
                      <li>
                        ...
                        <br className="d-none d-sm-block" /> o camiseta en otra
                        fecha que la programada.
                      </li>
                    </ol>
                  </p>
                </Col>
                  ...
                  <p className="texto-lachismosa">
                    <ol start="3" className="lista-carrera">
                      <li>
                        ...
                        entregan kits el día de la carrera ni se reembolsará el
                        dinero de la inscripción.
                      </li>
                    </ol>
                  </p>
                </Col>
        ...
        <Row className="mt-3 mt-md-4 d-flex justify-content-center">
          <Col md={8} className="mt-4 mt-md-5 text-center">
            ...
            <p className="texto-lachismosa mt-4 mt-md-5">
              ...
              curaciones, traslados adicionales, hospitalización o internación,
              exámenes de laboratorio e imagen, procedimientos no quirúrgicos o
              quirúrgicos, correrán por cuenta del participante o competidor.
            </p>
            <p className="texto-lachismosa">
              Las imágenes que se obtengan en la competencia podrán ser
              utilizadas por los organizadores del evento y por las empresas
              auspiciantes para fines de difusión y publicidad del evento y/o de
              productos asociados al mismo. Los competidores que acepten
              participar no tendrán derecho a realizar reclamos por el uso de su
              imagen.
            </p>
            <p className="texto-lachismosa">
              Los organizadores del evento tiene la facultad para modificar el
              recorrido establecido; detener la carrera en caso de inclemencias
              del tiempo u otro impedimento que imposibilite el normal
              desarrollo de la misma; o desviar el curso de ella en caso de
              dificultades en el terreno, inclemencias del tiempo o hechos
              inesperados.
            </p>
          </Col>
        </Row>
