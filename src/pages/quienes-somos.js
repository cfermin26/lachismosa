              ...
              <Container>
                <Row className="d-flex justify-content-center mt-5 mb-4 pt-md-5">
                  <Col md={8} className="text-center">
                    ...
                    <p className="texto-lachismosa mb-0 pt-2">
                      ...
                      audio visual, sirva además de entretener e informar,
                      también para culturizar, motivar y guiar de una forma
                      sana, divertida e informal, basados en nuestra filosofía
                      de transmitir buenas noticias, con una actitud positiva y
                ...
                <Row className="d-flex justify-content-center mt-5 mb-4 pt-md-5">
                  <Col md={8} className="text-center">
                    ...
                    <p className="texto-lachismosa mb-0 pt-2">
                      Ser un medio de comunicación audio visual, con
                      equipamiento de última tecnología, que brinda al público
                      en general una programación AAA, con responsabilidad y
                      visión social, basada en valores ligados a la consecución
                      de una sociedad más justa y democrática, con programación
                      imparcial, contrastada, moderna y entretenida, apta para
                      todo público.
                    </p>
                  </Col>
                </Row>
                <Row className="d-flex justify-content-center mt-5 mb-4 mb-md-5 pb-md-5 pt-md-5">
                  <Col md={8} className="text-center">
                    ...
                    <p className="texto-lachismosa mb-0 pt-2">
                      Ser la radio con mayor sintonía en las provincias de Azuay
                      y Cañar a través de la transmisión de su programación en
                      las frecuencias 104.1 104.5 y 102.9 y de sus canales
                      digitales vía streaming, a fin de llegar a los más altos
                      estándares de calidad en servicio a nuestra audiencia, con
                      excelente sonido, fidelidad y ofreciendo información
                      fresca, real, interesante, entregada con respeto y
                      objetividad.
                    </p>
                  </Col>
                </Row>
